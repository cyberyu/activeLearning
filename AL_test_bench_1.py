...
test the binary classification on Newsgroup data
...
# newsgroup
from load_data import load_newsgroup_data
dt = load_newsgroup_data()
docs = dt['docs']
label = dt['label']
...
out = build_features(docs, keyWords=None, max_words= 1000, Stem = True, Bigram=True, Tfidf=True, stopwords=True, Preprocess=True)
features = out['TDM']
terms = out['terms']
...
accuracy = []
Nrecs = 20;  # number of new labels in each iteration
